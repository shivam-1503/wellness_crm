...
@section('content')
    ...
    @php $security_types = ['ssl_tls' => 'SSL/TLS', 'none' => 'None']; @endphp
            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('business/email_details') }}">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="social_settings" role="tabpanel">
                                ...
                                <div class="col-md-12">
                                    <div class="float-end">
                                        <a class="btn btn-primary float-end" href="javascript:void(0)"
                                            id="updateEmailDetails"><i class="fa fa-plus"></i> Update Details</a>
                                    </div>
                                </div>
                            </div>


                            <h5 class="text-muted">EMAIL ACCOUNT DETAILS</h5>
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>Security Type</td>
                                    <td>{{$security_types[$data->security_type]}}</td>
                                </tr>
    ...
    @include('view-modals/business/email_details')
...
@section('scripting')
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#updateEmailDetails', function() {

            // reset_modal();
            $.get("{{ url('business/edit_email_details') }}", function(data) {
                $('#emailDetailModalHeading').html("Edit Basic Details:");
        ...
        $("#emailForm").validate({
            ...
            messages: {
                email_id: {
                    required: "Emil Account is Required",
                    email: "Please Enter Valid Emil Account",
                },
                password: "Password is Required.",
                security_type: "Please Select Security Type.",
            ...
            submitHandler: function(form) {
                ...
                $('#EmailDetailsSaveBtn').html('Sending..');

                $.ajax({
                    data: $('#emailForm').serialize(),
                    url: "{{ url('business/email_details/store') }}",
                    type: "POST",
                    dataType: 'json',
                    ...
                    error: function(data) {
                        ...
                        $('#emailDetailsSaveBtn').html('Save Changes');
                    }
                });
            }
        });
