...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('business/basic_details') }}">
                                Basic Details
                            </a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="col-md-12">
                                    <div class="float-end">
                                        <a class="btn btn-primary float-end" href="javascript:void(0)"
                                            id="updateBasicDetails"><i class="fa fa-plus"></i> Update Details</a>
                                    </div>
                                </div>
                            </div>
    ...
    @include('view-modals/business/basic_details')
