...
<div class="page-header">
    <div>
        <h1>Designations <small>List & Management</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="float-end">
            <a class="btn btn-primary float-right" href="javascript:void(0)" id="createNewProduct"> <i class="fa fa-plus"></i> Create Deignation</a>    
    </div>
...
<!-- PAGE-HEADER END -->
    ...
    @include('view-modals/designation_addedit');
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function( $ ) {
		...
		$('body').on('click', '.editProduct', function () {
		  ...
		  reset_modal();
		  $.get("{{ url('designation/edit') }}" +'/' + product_id, function (data) {
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "{{ url('designation/delete') }}"+'/'+customer_id,
                            success: function (data) {
                                table.draw();
                    ...
                    {
                        swal("Your Designation delete request Cancelled!")
                    }
