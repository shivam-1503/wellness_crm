...
<div class="page-header">
    <div>
        <h1>Services <small>List & Management</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="float-end">
		<a class="btn btn-primary float-end" href="javascript:void(0)" id="createNewProduct"><i class="fa fa-plus"></i> Create Service</a>
    </div>
...
<!-- PAGE-HEADER END -->
	...
	@include('view-modals/service_addedit')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$('body').on('click', '.editProduct', function () {
		  ...
		  reset_modal();
		  $.get("{{ url('service/edit') }}" +'/' + product_id, function (data) {
		...
		$('body').on('click', '.deleteProduct', function () {
			...
			.then((willDelete) => {
  				if (willDelete) {
					...
					$.ajax({
				        type: "GET",
				        url: "{{ url('service/delete') }}"+'/'+product_id,
				        success: function (data) {
				            table.draw();
				            swal("Great! Service has been deleted!", {
						      icon: "success",
						    });
				        },
				        error: function (data) {
				...
				{
					swal("Your Service delete request Cancelled!")
				}
