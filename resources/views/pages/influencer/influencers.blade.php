...
<div class="page-header">
    <div>
        <h1>Influencers <small>List & Management</small></h1>
        <ol class="breadcrumb">
...
<div class="content mt-3">
    ...
    @include('view-modals/influencer_addedit') 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$('body').on('click', '.editProduct', function () {
		  	...
		  	reset_modal();
		  	$.get("{{ url('influencer/edit') }}" +'/' + product_id, function (data) {
