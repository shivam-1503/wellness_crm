...
@section('content')
	...
	<div class="main-container container-fluid">
		<div class="page-header">
			<h1 class="page-title">Promotion Codes <small> List & Management</small></h1>

			<button type="button" class="modal-effect btn btn-primary d-grid mb-3" data-bs-effect="effect-scale" data-bs-toggle="modal" id="createNewProduct" data-bs-target="#ajaxModel"> Generate Promotion Codes</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$('#createNewProduct').click(function () {
		    ...
		    $('#modelHeading').html("Generate Promotion Codes");
