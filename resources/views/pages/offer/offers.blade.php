...
<div class="page-header">
    <div>
        <h1>Offers <small>List & Management</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="float-end">
		<a class="btn btn-primary float-right" href="javascript:void(0)" id="createNewProduct"> Create Offer</a>
    </div>
...
@include('view-modals/offer_addedit') 
