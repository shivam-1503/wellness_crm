...
<div class="page-header">
    <div>
        <h1>Gifts <small>List & Management</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="float-end">
		<a class="btn btn-primary float-right" href="javascript:void(0)" id="createNewProduct"> Create Gift</a>
    </div>
		...
		<div class="card radius-10">
			<div class="card-body">
				<div class="d-flex justify-content-between">
					...
					<button type="button" class="modal-effect btn btn-primary d-grid addkyc" data-bs-effect="effect-scale" data-bs-toggle="modal" id="addkyc" data-bs-target="#addkyc"> Add Gift</button>
				</div>
				<hr>
