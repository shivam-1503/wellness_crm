...
<div class="page-header">
    <div>
        <h1>Dealers <small>List & Management</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="float-end">
		<a class="btn btn-primary float-right" href="javascript:void(0)" id="createNewProduct"> Create New Dealer</a>
    </div>
...
<div class="content mt-3">
					...
					<table  class="table table-bordered text-nowrap border-bottom data-table w-100">
						<thead>
							<tr>
								...
								<th class="border-bottom-0">Dealer Name</th>
    ...
    @include('view-modals/dealer_addedit') 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$('#createNewProduct').click(function () {
		    ...
		    $('#modelHeading').html("Create New Dealer");
		...
		$('body').on('click', '.editProduct', function () {
		  	...
		  	reset_modal();
		  	$.get("{{ url('dealer/edit') }}" +'/' + product_id, function (data) {
		...
		$('body').on('click', '.deleteProduct', function () {
			...
			$.ajax({
				type: "GET",
				url: "{{ url('dealer/delete') }}"+'/'+product_id,
				success: function (data) {
					table.draw();
					swal("Great! Dealer has been deleted!", {
						icon: "success",
					});
				},
				error: function (data) {
