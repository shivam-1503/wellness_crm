...
<div class="page-header">
    <div>
        <h1>Brands <small>List & Management</small></h1>
        <ol class="breadcrumb">
    ...
    <div class="float-end">
		<a class="btn btn-primary float-right" href="javascript:void(0)" id="createNewProduct"> Create New Brand</a>
    </div>
...
<!-- PAGE-HEADER END -->
	...
	@include('view-modals/brand_addedit')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$('body').on('click', '.editProduct', function () {
		  ...
		  reset_modal();
		  $.get("{{ url('brand/edit') }}" +'/' + product_id, function (data) {
		...
		$('body').on('click', '.deleteProduct', function () {
			...
			.then((willDelete) => {
  				if (willDelete) {
					...
					$.ajax({
				        type: "GET",
				        url: "{{ url('brand/delete') }}"+'/'+product_id,
				        success: function (data) {
				            table.draw();
				            swal("Great! Brand has been deleted!", {
						      icon: "success",
						    });
				        },
				        error: function (data) {
