...
<div class="modal fade" id="billModel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="card card-signup card-plain">


                {{ Form::open(['id' => 'billForm', 'name' => 'dataForm', 'class' => 'form-horizontal']) }}
                {{ Form::hidden('vendor_id', '', ['id' => 'vendor_ids']) }}
                ...
                <div class="modal-header">
                    <div class="card-header card-header-primary text-center" style="margin-top: -30px;">
                        ...
                        <h4 class="card-title" id="billModalHeading"></h4>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            {{ Form::select('title', [''=>'Select Title']+$bill_titles, '', ['class' => 'standardSelect form-control', 'title' => 'Select Title', 'data-live-search' => 'true', 'id' => 'title', 'data-dropup-auto' => 'false', 'data-size' => '5']) }}
                ...
                <div class="modal-footer">
                    ...
                    {!! Form::submit('Submit', ['class' => 'btn btn-primary', 'id' => 'billBtn']) !!}
