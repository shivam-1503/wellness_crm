...
@php $types = ['SaaS Product'=>'SaaS Product', 'Service'=>'Service']; @endphp
    ...
    <div class="modal-dialog">
        ...
        <div class="card card-signup card-plain">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12">
                            {!! Form::select('type', [''=>'Select Type']+$types, '', ['class'=>'standardSelect form-control', 'title'=>'Select Service Type ', 'data-live-search'=>'true', 'id'=>'status' , 'data-style'=>'btn-sp', 'data-dropup-auto'=>'false', 'data-size'=>'5']) !!}
