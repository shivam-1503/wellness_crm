...
class OfferController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages/offer/offers', compact('states','districts'));
    }
    ...
    public function getOffersData()
    {
        ...
        return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $btn = '<abbr title="View"><a href="'.url("/offer/details/".$row->id).'" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="View" class="edit btn btn-primary btn-sm"><i class="fa fa-eye"></i></a></abbr>';
    ...
    public function offer_details(string $id)
    {
        ...
        return view('pages/offer/offer-details', compact('offer'));
        
    }


    public function getGiftsData($offer_id = false)
    {
        $data = Gift::latest()
    ...
    public function generate_codes(Request $request)
    {
        ...
        return view('pages/offer/generate-codes', compact('products'));
    }
